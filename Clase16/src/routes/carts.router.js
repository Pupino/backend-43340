...
//cart creation (empty of products) and associated to userId
//routerCarts.post('/:uid', cartsController.createEmptyCart);
routerCarts.post('/', cartsController.createEmptyCart);

//PUT api/carts/:cid deberá actualizar el carrito con un arreglo de productos con el formato especificado arriba.
routerCarts.put('/:cid', isUser, cartsController.updateProdcuctsCart);
