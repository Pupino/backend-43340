  ...
  getRegister(_, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to get register',
  ...
  postRegister(req, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to post register',
  ...
  failRegister(req, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to fail register',
  ...
  loginForm(req, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to login form',
  ...
  failLogin(req, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to fail login',
  ...
  getPerfil(req, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to get perfil',
  ...
  getAdministracion(_, res) {
    try {
      ...
      CustomError.createError({
        ...
        cause: 'Please contact development team',
        message: 'Error trying to get administration',
