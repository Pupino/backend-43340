...
productsRouter.post('/', isAdmin, productController.postProduct);
productsRouter.put('/:pid', isAdmin, productController.updateProduct); //ROMINA: ofrecer una vista desde donde llamar a la api al momento de hacer submit de UPDATE
productsRouter.delete('/:pid', isAdmin, productController.deleteProduct); //ROMINA: ofrecer una vista desde donde llamar a la api al momento de hacer submit de DELETE
...
productsRouter.get('/mockingproducts', async (req, res) => {
  try {
    ...
    CustomError.createError({
      ...
      message: 'Error trying to generate products Mocking',
