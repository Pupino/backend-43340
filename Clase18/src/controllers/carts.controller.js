...
class CartsController {
  ...
  async createEmptyCart(req, res) {
    try {
      ...
      logger.debug(`createEmptyCart line 71 cart DTO: ${JSON.stringify(cart)}`);
  ...
  async purchase(req, res) {
    try {
      ...
      logger.debug(`purchase line 248 productsOk: ${productsOk}`);
      logger.debug(`purchase line 249 productsNoStock: ${productsNoStock}`);
